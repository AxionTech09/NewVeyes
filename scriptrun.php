...
-on the Add arguments section, enter script path like -> -f  C:\wamp\www\processcontrol\scriptrun.php
...
curl_setopt($ch, CURLOPT_URL, "http://127.0.0.1/processcontrol/preinspection/scriptprecom?ro=Chennai");
