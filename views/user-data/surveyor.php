...
<div class="userdata-index">
    ...
    <p>
        <?= Html::a('Create Surveyor', ['create-surveyor'], ['class' => 'btn btn-success']) ?>
    </p>
             ...
             'template' => '{view}{update}{resetPassword}{delete}',  
               'buttons'  => [
                        'view'   => function ($url, $model) {
                            $url = Url::to(['user-data/view-surveyor', 'id' => $model->id]);
                            return Html::a(FA::icon('eye', ['class' => 'text-pink mr-5 mt-5']), $url, [
                            'title' => Yii::t('app', 'View'),
                            ]);
                        },
                        'update' => function ($url, $model) {
                            $url = Url::to(['user-data/update-surveyor', 'id' => $model->id]);
                        ...
                        'delete' => function ($url, $model) {
                            return  Html::a(FA::icon('trash', ['class' => 'text-limered mr-5 mt-5']), ['user-data/delete-surveyor', 'id' => $model->id], [
                            'data'=>[
                                'method' => 'post',
