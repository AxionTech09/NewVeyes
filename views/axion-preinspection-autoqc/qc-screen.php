...
$gridColumns = [
    ...
    'buttons' => [
            ...
            'vehicleqc' => function ($url, $model, $key) {
                ...
                {
                    return '<div class="row">'.Html::a(FA::icon('user-check text-darkYellow', ['class' => 'mr-5 mt-5']), Yii::$app->request->baseUrl.'/axion-preinspection/pi-qc-screen?id='.$key.'&page=completed', [
                        'class' => '',
                        'title' => Yii::t('yii', 'QC'),
                        'data-id' => $key,
                        'data-pjax' => '0',
