...
$gridColumns = [
	...
	//'template' => '{view} {update} {delete}',
        'template' => Helper::filterActionColumn('{update}{transaction}{qc}{completed}'),
	 ...
	 'buttons' => [
	    ...
	    'update' => function ($url, $model, $key) {
            ...
            'qc' => function ($url, $model, $key) {
                if(strtolower(preg_replace('/[^\w]/', '', $model->vehicleType)) == '4wheeler')
                {
                return Html::a('<span class="glyphicon glyphicon-check"></span>',Yii::$app->request->baseUrl.'/axion-preinspection/fourwheelerqc?id='.$key, [
                ...
                {
                   return Html::a('<span class="glyphicon glyphicon-check"></span>',Yii::$app->request->baseUrl.'/axion-preinspection/commercialqc?id='.$key, [
                    'class' => 'activity-transaction-link',
                    'title' => Yii::t('yii', 'QC'),
                    'data-id' => $key,
                    'data-pjax' => '0',
            ...
            */
            'transaction' => function ($url, $model, $key) {
                return Html::a('<span class="glyphicon glyphicon-file"></span>',Yii::$app->request->baseUrl.'/axion-preinspection/transaction?id='.$key, [
                    'class' => 'activity-transaction-link',
...
// the name column configuration
    ...
    [
        'attribute'=>'executiveMobileNo',
        'vAlign'=>'middle',
        'headerOptions'=>['style'=>'border: 2px #000 solid;background-color:#337ab7;'],
    ],

    [
        'attribute'=>'executiveEmailId',
        'vAlign'=>'middle',
        'headerOptions'=>['style'=>'border: 2px #000 solid;background-color:#337ab7;'],
    ],
