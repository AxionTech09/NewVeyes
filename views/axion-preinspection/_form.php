        ...
        <div id="inspection_details" class="panel panel-primary pb-15 mt-40" style="display: <?= $inspectionDisplay; ?>"> 
            ...
            <div class="panel-body">
                ...
                */ ?>
                ...
                <?php 
                if (($role != 'Superadmin' || $role == 'Admin') && ($model->insurerName == 10)) { 
                    $readOnlyinput = true;
                }else{
                    $readOnlyinput = false;
                }
                ...
                <div class="col-sm-4 col-md-3 text-error">  
                    <?= $form->field($model, 'paymentMode')->dropDownList($paymentArray,['id' => 'paymentMode','disabled' => $readOnlyinput]) ?>
                </div>  
            ...
            if ($('#newRecord').val() == 'N') {
                ...
                function( data ) {
                    ...
                    if(data.counts >= 1){
                        ...
                        $('#registrationNoWarning, #cashCollectionDiv').hide();
                        console.log('#registrationNoWarning & #cashCollectionDiv hide '+ data.counts);
                    }    
