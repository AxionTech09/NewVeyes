...
$gridColumns = [
    ...
    //'template' => '{view} {update} {delete}',
       'template' => Helper::filterActionColumn('{update}{transaction}{sms}{changerolist}'),
...
// the name column configuration
    [
        ...
        'filterOptions' => ['style'=>'border: 2px #000 solid !important;','disable'=> 'disable']
    ],
    ...
    [
        ...
        'filterType'=>GridView::FILTER_SELECT2,
        'filter'=>['0'=>'Fresh Case', '100'=>'Change RO'],
        'filterWidgetOptions'=>[
                'pluginOptions' => [
                    'allowClear'=>true,
                    'tags' => true,
...
<?php Modal::begin([
    ...
    'footer' => '',
    'clientOptions' => ['backdrop' => 'static', 'keyboard' => false], // Add this line
]); ?>
<?php Modal::end(); ?>
