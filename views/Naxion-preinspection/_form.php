...
<div class="preinspection-form" style="height:<?php echo $height;?>;">
    ...
    <?= $form->field($model, 'referenceNo')->textInput(['readonly' =>true]) ?>
         ...
         <?php
          ...
          echo $form->field($model, 'vehicleType')->hiddenInput(['value' => 'ALL-VEHICLE'])->label(false);
        
    ?>  

    <?php echo $form->field($model, 'vehicleTypeRadio')->hiddenInput($vehicleTypeRadioArray)->label(false); ?>
