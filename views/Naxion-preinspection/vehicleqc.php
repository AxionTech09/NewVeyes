...
$glassType1Array = $model->glassType1value;
...
<div class="axion-preinspection-fourwheelerqc">
 ...
 <table class="table" border="2">
    ...
    <div class="form-prerow-other">    
    <?= $form->field($premodel, 'registrationNo')->label('Registration No *') ?>
    </div>    

    <div class="form-prerow-other">
    <?= $form->field($premodel, 'engineNo')->label('Engine No *') ?>
    </div>

    <div class="form-prerow-other">
    <?= $form->field($premodel, 'chassisNo')->label('Chassis No *') ?>
    </div>   
    
    <div class="form-prerow-other">
    <?= $form->field($model, 'vType')->dropDownList($vTypeArray,['prompt' => 'Select'])->label('Vehicle *') ?>
    </div>
    ...
    <h4 class="preinspection-box-title">Vehicle General Details</h4>
     <div id="inspection_details" class="preinspection-box">
        ...
        <div class="form-prerow-other">
        <?= $form->field($model, 'odometerReading')->label('Odometer Reading *') ?>
        </div>
        <div class="form-prerow-other">
        ...
        <?= $form->field($model, 'frontwsGlassLaminated')->dropDownList($glassTypeArray) ?>
         ...
         <div class="form-prerow-other">
             <?= $form->field($model, 'underCarriage')->dropDownList($glassType1Array) ?>
         </div> 

         <div class="form-prerow-other">     
            <?= $form->field($premodel, 'remarks')->label('Remarks *') ?>
         </div>

        <div class="form-prerow-other">  
             <?= $form->field($premodel, 'status')->dropDownList($statusArray)->label('Status *') ?>  
         </div>    
...
<?php } ?>
  <div class="clear"></div>
    ...
    <div class="form-group" style="text-align: center;margin-top: 30px;">
        ...
        <?php if($premodel->status == 101 || $premodel->status == 102 || $premodel->status == 104) {echo Html::a('<i class="fa glyphicon glyphicon-hand-up"></i> Submit and Generate Report', ['/axion-preinspection/vehiclepdf?id='.$premodel->id], [
