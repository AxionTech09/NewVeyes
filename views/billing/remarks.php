...
<div class="preinspection-form">
    ...
    <?= $form->field($model, 'billId')->hiddenInput(['style'=>'width:500px','id'=>'billId','value'=>$billId])->label(false) ?>
...
$url = Yii::$app->request->baseUrl.'/billing/add-remarks';

$summaryUrl = Yii::$app->request->baseUrl.'/billing/summary';
