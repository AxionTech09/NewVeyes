...
<div class="container">
    ...
    <table border="1">
        <tr>
            <td rowspan="3" colspan="2">
                ...
                <h6> No 6234 TNHB Layout Ayapakkam Chennai, 600077, <br>
                    ...
                    E-Mail : kavitha.naveenraj@axionpcs.in <br>
                </h6>
            </td>
            <td colspan="2">
                <div>Invoice No.</div>
        ...
        <tr>
            <td class="border-topNone border-bottomNone padding-bottomNone"><?=($companyId == 9) ? '3' : '2'?></td>
        ...
        <tr>
            <td class="border-topNone border-bottomNone padding-bottomNone"><?= ($companyId == 10) ? '5' : (($companyId == 9) ? '4': '3') ?></td>
        ...
        <tr>
            ...
            <td colspan="4">
                ...
                <img src="images/Billing_digital_sign.jpg" alt="digital-sign" height="100">
                <!-- <br><br><br><br><br><br> -->
