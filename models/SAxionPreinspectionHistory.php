...
class AxionPreinspectionHistory extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id', 'referenceNo', 'manufacturingYear', 'cityId', 'townId', 'extraKM', 'surveyorName', 'paymentMode', 'status', 'cancellationReason', 'userId', 'followupReason', 'preinspection_id','insurerName', 'insurerDivision', 'insurerBranch', 'callerName'], 'integer'],
