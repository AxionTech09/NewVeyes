...
class AxionPreinspectionPhotos extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['image'], 'file','extensions' => 'jpg, jpeg, mp4'],
    ...
    public function getTypeName()
    {
        $list= [
                ...
                ['id' => 'odometerWithRPMReading', 'name' => 'Odometer With RPM Reading'],
                ['id' => 'closeupViewOfOdometerReading', 'name' => 'Closeup View Of Odometer Reading'],
                ['id' => 'frontWindshieldFromOutside', 'name' => 'Front Windshield From Outside'],
                ['id' => 'cngLpgKit', 'name' => 'CNG/LPG Kit'],
                ['id' => 'rcCopy', 'name' => 'RC Image Front'],
                ['id' => 'rcImageFront', 'name' => 'RC Image Front'],
                ['id' => 'rcImageBack', 'name' => 'RC Image Back'],
                ...
                ['id' => 'vehicleVideo', 'name' => 'Vehicle Video'],
              ];
