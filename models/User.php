...
class User extends \yii\db\ActiveRecord implements \yii\web\IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['mobile'], 'required','except' => 'api-create'],
            [['createdOn','lastUpdatedOn','activeFromDate','royaltyOnFees','royaltyOnConveyance','roCompletedCase','basicSalary','feesPerCase','conveyanceAmount','conveyancePerKM','joiningDate'], 'safe'],
            [['basicSalary','feesPerCase','conveyanceAmount','conveyancePerKM'],'double'],
            [['stateId','cityId','companyId','branchId','divisionId','branchHeadId','surveyorId','roId'], 'integer'],
            [['email','password'], 'string', 'max' => 255],
            [['address', 'channel', 'agent_code', 'zone', 'remarks'],'string'],
            ...
            [['salaryType','conveyanceType'],'string','max'=>30],
            [['salaryType','conveyanceType'],'required','on'=>'surveyor' ],
            [['password_repeat','password'], 'required','on'=>'change-password'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'royaltyOnFees' => 'Royalty % on Fees',
            'royaltyOnConveyance' => 'Royalty % on Conveyance',
            'roCompletedCase' => 'Royalty % on Completed Case',
        ];
    }
    ...
    public function beforeSave($insert)
    {
        if (parent::beforeSave($insert)) {
            ...
            // Checks whether password is already not hashed 
            if(isset($this->password) && !preg_match('/\$2y\$13/i', $this->password)) 
